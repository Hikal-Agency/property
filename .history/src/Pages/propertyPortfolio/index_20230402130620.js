                                ...
                                <div className="space-y-3">
                                    {developer.length > 0 ? (
                                        developer.map((developer, index) => {
                                            return (
                                                <div className={`${currentMode === "dark" ? "text-white" : "text-black"} w-full p-3 bg-gray-200 rounded-md space-y-3`}>
                                                    ...
                                                    {developer.projects.length > 0 ? (
                                                        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-3">
                                                            {developer.projects.map((project, i) => {
                                                                return (
                                                                    <div className={`${currentMode === "dark" ? "bg-gray-900" : "bg-gray-200"}`}>{project.project} & {project.studio}</div>
                                                                )
                                                            })}
