                                                        ...
                                                        {developer.projects.length > 0 ? (
                                                            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-3">
                                                                {developer.projects.map((project) => {
                                                                    return (
                                                                        <div className={`${currentMode === "dark" ? "bg-gray-900" : "bg-gray-200"} w-full h-full p-3 rounded-md space-y-3`}>
                                                                            <div className="text-main-red-color font-semibold">{project.project}</div>
                                                                            <hr className="h-0.5"></hr>
                                                                            <div className="flex items-center gap-3">
                                                                                {project.studio === 1 ? (
                                                                                    <GrCheckboxSelected size={"20px"} className="text-main-red-color bg-white" color="#16a55a" />
                                                                                ) : (
                                                                                    <GrCheckbox size={"20px"} />
                                                                                )}
                                                                                <p>hhdh</p>
                                                                                <p>djnckd</p>
                                                                            </div>
