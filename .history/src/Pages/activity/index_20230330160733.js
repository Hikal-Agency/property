                                                        ...
                                                        {activity.feedback !== "" ? (
                                                            activity.feedback !== "Meeting" ? (
                                                                <>
                                                                    ...
                                                                    >
                                                                        <div className="w-full mt-4 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-5">
                                                                            <div className="col-span-1 space-3">
                                                                                {activity.leadName}
                                                                                <br></br>
                                                                                <span className="italic">{activity.enquiryType}&nbsp;{activity.project}</span>
                                                                            </div>
                                                                            <div className="col-span-1 sm:col-span-1 md:col-span-2 lg:col-span-3 xl:col-span-4 2xl:col-span-5 space-3">
                                                                                I am activity
                                                                            </div>
                                                                        </div>
                                                                        <p
