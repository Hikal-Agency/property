                                                        ...
                                                        {activity.feedback !== "" ? (
                                                            activity.feedback !== "Meeting" ? (
                                                                <>
                                                                    ...
                                                                    >
                                                                        <div className="w-full grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-5">
                                                                            <div className="col-span-1 space-3">
                                                                                {activity.leadName}
                                                                                <br></br>
                                                                                <span className="italic">{activity.project}&nbsp;{activity.enquiryType}</span>
                                                                            </div>
