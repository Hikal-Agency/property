                                                        ...
                                                        {activity.feedback !== "" ? (
                                                            activity.feedback !== "Meeting" ? (
                                                                <>
                                                                    ...
                                                                    >
                                                                        <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7 space-5">
                                                                            <div className="col-span-1 space-3">

                                                                            </div>
                                                                            <div className="col-span-2 sm:col-span-2 md:col-span-3 lg:col-span-4 xl:col-span-5 2xl:col-span-6 space-3">
