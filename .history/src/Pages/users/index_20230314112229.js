        ...
        >
          ...
          <div className="grid grid-cols-4 gap-5">
            ...
            <div className="col-span-3 space-y-5">
              <div className={`${currentMode === "dark" ? "bg-gray-900 text-white" : "bg-gray-200 text-black"} space-y-3 p-5 rounded-md w-full h-fit`}>
              ...
              <div className={`${currentMode === "dark" ? "text-white" : "text-black"} space-y-3 p-5 rounded-md w-full h-fit`}>
                <div className="flex items-center justify-between">
                  <div className="flex space-x-2">
                    <h6
                      className={`font-bold ${
