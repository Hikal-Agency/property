        ...
        >
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4 gap-5">
            ...
            <div className="col-span-3 space-y-5">
              <div className={`${currentMode === "dark" ? "text-white" : "text-black"} p-3 w-full md:grid md:grid-cols-2 lg:grid-cols-1`}>
                <div className="sm:block md:block lg:flex xl:flex 2xl:flex items-center justify-between">
                  <div className="sm:block md:block lg:flex xl:flex 2xl:flex space-x-2 space-y-2">
                    <h6
                      className={`font-bold`}
                    >
                      Contact Number:
              ...
              <div className={`${currentMode === "dark" ? "text-white" : "text-black"} space-y-3 p-3 w-full grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-3 2xl:grid-cols-3 gap-5`}>
                <div className="sm:block md:block lg:flex xl:flex 2xl:flex items-center justify-between">
