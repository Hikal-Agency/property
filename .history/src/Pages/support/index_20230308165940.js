        ...
        >
          <div className="flex">
            ...
            <div className={`w-full `}>
              <div className="px-5">
                <Navbar />
                <h4 className="font-semibold p-7 text-center text-4xl">Welcome to <span className="text-main-red-color font-bold">HIKAL CRM</span>! We are here to assist you.</h4>
                <h1 className="p-5"></h1>
                <div
                  className={`${
                    currentMode === "dark"
