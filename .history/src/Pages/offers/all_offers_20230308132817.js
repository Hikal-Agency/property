  ...
  const offer = [
        {
            ...
            "offerTitle":"Win iPad",
            "offerDescription": "Get a chance to win latest iPad 14 Pro Max by closing AED 5 Million plus direct deals this month.",
                        ...
                        return (
                            offer.validToManager === 1 && offer.validToSales === 1 ? (
                                <div className={`${currentMode === "dark" ? "bg-black text-white" : "bg-white text-black"} p-5 rounded-md`}>
                                    <h1 className="font-semibold text-main-red-color mb-2">{offer.offerTitle}</h1>
                                    <hr className="mb-3"></hr>
                                    <h6 className="mb-3 p-2">{offer.offerDescription}</h6>
                                    <hr className="mb-3"></hr>
                                    <h1 className="bg-main-red-color text-white font-semibold rounded-md p-2">Valid from {offer.valid_from} to {offer.valid_to}</h1>
                                </div>
                            ) : (
                                <>
                                {/* <h1 className="italic">No offers for both Managers and Agents</h1> */}
                                </>
                            )
                        )
                    })}
