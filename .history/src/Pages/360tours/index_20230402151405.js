                    ...
                    >
                        <div className="px-5">
                            ...
                            <div className="mt-5 md:mt-2">
                                ...
                                <div>
                                    <iframe width="100%" height="640" frameborder="0" allow="xr-spatial-tracking; gyroscope; accelerometer" allowfullscreen scrolling="no" src={tour[devproid].tourlink}></iframe>
                                </div>
