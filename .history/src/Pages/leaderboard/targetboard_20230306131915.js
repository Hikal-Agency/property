        ...
        <div>
            ...
            >
                ...
                <TabPanel value={tabValue} index={0}>
                    <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 gap-12">
                        <div
                        className={`${
                            ...
                            <div>
                                {Manager.map((item, index) => {
                                    return (
                                        ...
                                        >
                                            <div className="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-4 xl:col-span-4 2xl:col-span-3 flex items-center">
                                                <img
                                                src="/favicon.png"
                                                height={60}
                                                width={60}
                                            ...
                                            <div className="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-8 xl:col-span-8 2xl:col-span-9 flex gap-x-3 align-center content-center items-center">
