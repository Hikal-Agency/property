                            ...
                            <div>
                                {Manager.map((item, index) => {
                                    return (
                                        ...
                                        >
                                            <div className="sm:col-span-12 md:col-span-12 lg:col-span-4 xl:col-span-4 2xl:col-span-4 flex items-center">
                                                <img
                                                src="/favicon.png"
                                                height={60}
                                                width={60}
                                            ...
                                            <div className="sm:col-span-12 md:col-span-12 lg:col-span-8 xl:col-span-8 2xl:col-span-8 flex gap-x-3 align-center content-center items-center">
