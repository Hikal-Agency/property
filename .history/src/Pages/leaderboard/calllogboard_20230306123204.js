...
const CallLogBoard = () => {
  ...
  return (
    <>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-x-3 gap-y-3 pb-3">
                    ...
                    <div className={`${currentMode === "dark" ? "bg-gray-900 text-white" : "bg-gray-200 text-black"} p-3 rounded-md`}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-3">
                            <div className={`${currentMode === "dark" ? "bg-black text-white" : "bg-white text-black"} rounded-md p-2`}>
                                <h6 className="text-center font-semibold underline">Outgoing</h6>
                                <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 gap-3 mt-2">
                                    <div>
                                        <h1 className="font-semibold text-center text-lg">3000</h1>
                                        <h6 className="text-main-red-color text-center">ANSWERED</h6>
                                    </div>
                                    <div>
                                    <h1 className="font-semibold text-center text-lg">30</h1>
