                                    ...
                                    >
                                        <div class="grid grid-cols-7 gap-3">
                                            <div className="col-span-1 flex items-center justify-center">
                                                <BiUserCircle size={"30px"} color={"#da1f26"} />
                                            </div>
                                            <div className="col-span-6 flex h-full items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="font-semibold text-sm tracking-wide flex items-center">
                                                        <BiUserCircle className="mr-2" />Meeting Scheduled for <span class="text-main-red-color">{activity.meetingDate} {activity.meetingTime}</span>
                                                    </p>
