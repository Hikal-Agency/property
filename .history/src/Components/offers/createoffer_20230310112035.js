            ...
            <div className={`${currentMode === "dark" ? "bg-black text-white" : "bg-white text-black"} rounded-md p-5`}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 gap-5 py-5">
                    ...
                    <div className={`${currentMode === "dark" ? "bg-gray-900" : "bg-gray-200"} rounded-md p-5 mx-5`}>
                        <Box sx={darkModeColors}>
                            <label className="font-semibold text-sm mb-3"><span className="text-main-red-color">Valid for:</span></label>
                            <br></br>
                            ...
                            <FormControl>
                                <RadioGroup
                                    ...
                                    className="mb-5"
                                >
                                    <FormControlLabel className="mb-3" value="Managers" control={<Radio />} label="Sales Managers" />
                                    <FormControlLabel className="mb-3" value="Agents" control={<Radio />} label="Sales Agents" />
                                    <FormControlLabel className="mb-3" value="Both" control={<Radio />} label="Both" />
                                </RadioGroup>
                            </FormControl>
                        </Box>
                    </div>
