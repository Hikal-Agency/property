        ...
        <div className={`${currentMode === "dark" ? "bg-black" : "bg-white"} rounded-md space-3 p-7`}>
          ...
          <FormControl>
            <RadioGroup
              ...
              className="mb-3"
            >
              <FormControlLabel value="Invoice" control={<Radio />} label="Invoice (Free)" />
              <FormControlLabel value="CreditDebitCard" control={<Radio />} label="Credit / Debit Card (Free)" />
              <FormControlLabel value="Paypal" control={<Radio />} label="Paypal (Free)" />
            </RadioGroup>
          </FormControl>
