...
// START 
import { Button, Checkbox, Alert, Box, Input } from "@mui/material";
  ...
  return (
    ...
    {/* --------START------------ */}
      ...
      <TableContainer component={Paper}>
        ...
        <div className="bg-main-red-color w-full h-fit flex justify-end">
          <Input
            className="m-3 flex justify-end items-right text-white"
            size="lg"
            bordered
            clearable
            placeholder="Search..."
