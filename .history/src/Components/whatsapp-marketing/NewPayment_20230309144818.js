...
const NewPayment = () => {
  ...
  return (
    <div className={`${currentMode === "dark" ? "bg-black text-white" : "bg-white text-black"} w-full h-full rounded-md p-5`}>
      <h3 className="mb-3 font-semibold text-main-red-color text-center p-3">Select Payment Method</h3>
      <hr className="mb-5"></hr>
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 gap-5">
        <div className={`space-3 p-7`}>
        ...
        <div className="space-3 p-1 sm:pb-1 sm:pt-5 md:pb-1 md:pt-5 lg:pb-3 lg:pt-5 xl:p-5">
          ...
          <h3 className="mb-3 font-semibold text-main-red-color text-center"></h3>
