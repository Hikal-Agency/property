...
const userData = {
  "users": [
    ...
    },
    {
      "userId":124,
      "userName":"Ameer Ali",
      "before_location":[25.11310000002, 55.280889615218406],
      "beforeTime":"2023-03-04 15:00",
      "last_location":[25.11111110002, 55.280889615218406],
      "lastTime":"15:30",
    },
  ]
};
    ...
    >
      ...
      {userData.users.map(user => (
        <>
          ...
          {selectedUser ? (
            <InfoWindow             
              position={{ lat: parseFloat(selectedUser.last_location_lat), lng: parseFloat(selectedUser.last_location[1]}}
              onCloseClick={
