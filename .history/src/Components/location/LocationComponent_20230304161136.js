...
import { BsBuilding, BsRecordCircle } from "react-icons/bs";
            ...
            <div className="h-full w-full mt-5">
                ...
                {/* LIST OF UPCOMING MEETINGS */}
                    {upcoming_meetings?.map((meeting, index) => {
                        return (
                            <div className={`${currentMode === "dark" ? "bg-gray-900" : "bg-gray-200"} grid grid-cols-6 gap-3 rounded-md p-5 mt-3`}>
                                <div className={`${currentMode === "dark" ? "text-white" : "text-black"} col-span-5 space-y-2`}>
                                    ...
                                    <div className="w-full flex justify-between items-center">
                                        ...
                                        <BsRecordCircle
                                            className={`mr-2 
                                            ${meeting?.meetingStatus === "Attended" ? "text-green" : currentMode === "dark" ? "text-white" : "text-green"}`}
                                        />
                                        <p className="text-sm mr-3"> {meeting?.meetingStatus}</p>
                                        </div>
                                    </div>
                                    <div className="w-full flex justify-between items-center">
                                        <div className="flex items-center space-x-1">
