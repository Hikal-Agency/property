...
//   const position = [51.505, -0.09];
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-5 xl:grid-cols-5 gap-5 pb-3">
        <div className={`${currentMode === "dark" ? "bg-gray-900" : "bg-gray-200"} w-full h-[90vh] col-span-3`}>
            {/* MAP */}
            <MapContainer />
