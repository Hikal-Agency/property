...
//   const position = [51.505, -0.09];
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5 pb-3">
        <div className={`${currentMode === "dark" ? "bg-gray-900" : "bg-gray-200"} w-full h-[90vh] col-span-2`}>
            {/* MAP */}
            <MapContainer />
            
        </div>
        <div className="h-full w-full">
            <h4 className="text-red-600 font-bold text-xl mb-2">Meetings & Locations</h4>
            <div>
