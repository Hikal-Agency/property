...
import * as parksData from "../../data/locationdata.json";
...
function Map() {
  ...
  return (
    ...
    >
      {parksData.features.map(object => (
        <Marker 
          key={object.properties.mId} 
          position={{ lat: object.geometrics.coordinates[0], lng: object.geometrics.coordinates[1]}}
          onClick={() => {
            setSelectedPin();
          }} />
      ))}
