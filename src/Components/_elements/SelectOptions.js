...
export const language_options = [
    ...
    },
    {
      ...
      label: (
        <div style={{ fontFamily: "Noto Kufi Arabic" }}>
          عربي <span className="mx-2" style={{ fontFamily: "Noto Sans" }}>(Arabic)</span>
        </div>
      ),
    },
    {
      ...
      label: (
        <div style={{ fontFamily: "Noto Sans TC" }}>
          中国人 <span className="mx-2" style={{ fontFamily: "Noto Sans" }}>(Chinese)</span>
        </div>
      ),
    },
    {
      ...
      label: (
        <div style={{ fontFamily: "Noto Kufi Arabic" }}>
          فارسی <span className="mx-2" style={{ fontFamily: "Noto Sans" }}>(Farsi/Persian)</span>
        </div>
      ),
    },
    { 
    ...
    { 
      ...
      label: (
        <div style={{ fontFamily: "Noto Sans Hebrew" }}>
          עִברִית <span className="mx-2" style={{ fontFamily: "Noto Sans" }}>(Hebrew)</span>
        </div>
      )
    },
    { 
      ...
      label: (
        <div style={{ fontFamily: "Noto Sans Devanagari" }}>
          हिंदी <span className="mx-2" style={{ fontFamily: "Noto Sans" }}>(Hindi)</span>
        </div>
      )
    },
    { 
    ...
    },
    {
      ...
      label: (
        <div style={{ fontFamily: "Noto Kufi Arabic" }}>
          اردو <span className="mx-2" style={{ fontFamily: "Noto Sans" }}>(Urdu)</span>
        </div>
      ),
    },
];
...
export const priority_options = (t) => [
  {
    ...
    icon: <TbFlag3Filled size={16} className={`text-${priorityColors.High}-500`} />,
  },
  {
    value: "Medium",
    label: t("priority_medium"),
    icon: <TbFlag3Filled size={16} className={`text-${priorityColors.Medium}-500`} />,
  },
  {
    value: "Low",
    label: t("priority_low"),
    icon: <TbFlag3Filled size={16} className={`text-${priorityColors.Low}-500`} />,
  }
];
