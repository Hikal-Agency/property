...
const FiltersDropdown = ({
  ...
  return (
    <div  className={`fixed w-[250px] z-[1000] top-[40px] right-[8px] ${darkModeColors}`}>
    <div className="flex justify-end mt-5 relative z-[1000]">
      ...
      {filtersDropdown && (
        <div
        className="bg-[white] mt-2 border border-[#2f2f2f2b] p-4 rounded"
        >
               <div
            style={{
              position: "relative",
              width: "100%",
              marginTop: managerSelected ? "25px" : "0",
            }}
          >
            <label
          ...
          <div
            style={{
              position: "relative",
              width: "100%",
              marginTop: enquiryTypeSelected.id ? "25px" : "0",
            }}
          >
            <label
              htmlFor="enquiryType"
