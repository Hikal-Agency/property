  ...
  return (
    <div className="w-full flex items-center justify-center">
        ...
        <div className="clock-face">
            <div class={`${currentMode === "dark" ? "dark-mode" : "light-mode"} clock-face-background`}></div>
            <div
            className="hour-hand"
            style={{ transform: `rotate(${getHours()}deg)`, background: currentMode === "dark" ? "#FFFFFF" : "#000000" }}
            ></div>
            <div
            className="minute-hand"
            style={{ transform: `rotate(${getMinutes()}deg)`, background: currentMode === "dark" ? "#FFFFFF" : "#000000" }}
            ></div>
            <div
            className="second-hand"
            style={{ transform: `rotate(${getSeconds()}deg)` }}
            ></div>
            <div className="center-pin" style={{ background: currentMode === "dark" ? "#FFFFFF" : "#000000" }}></div>
        </div>
