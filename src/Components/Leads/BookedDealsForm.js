        ...
        >
          {loading ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                ...
                >
                  <h1
                    className={`text-center text-primary py-2 mb-5 uppercase font-semibold ${withDiscount && "border-b-2 border-primary"
                      }`}
                  >
                    <FormControlLabel
                      control={
                ...
                >
                  <h1
                    className={`text-center text-primary py-2 mb-5 uppercase font-semibold ${withCashback && "border-b-2 border-primary"
                      }`}
                  >
                    <FormControlLabel
                      control={
          ...
          <button
            ...
            className={`${currentMode === "dark"
              ...
              } w-full text-white p-3 font-semibold my-5 hover:mb-1`}
