  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: (cellValues) => {
        return (
          <>
            {cellValues.formattedValue.project === "null" ? "-" : cellValues.formattedValue.project}
            {cellValues.formattedValue.leadFor === "null" ? "-" : cellValues.formattedValue.leadFor}
          </>
        )
      }
    },
    {
      ...
      renderCell: (cellValues) => {
        return (
          <>
            {cellValues.formattedValue.enquiryType === "null" ? "-" : cellValues.formattedValue.enquiryType}
            {cellValues.formattedValue.leadType === "null" ? "-" : cellValues.formattedValue.leadType}
          </>
        )
      }
    },
