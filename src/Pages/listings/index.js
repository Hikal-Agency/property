...
import { bathroom_options, enquiry_options, property_options } from "../../Components/_elements/SelectOptions";
        ...
        >
          <div className="">
            ...
            <div className={`flex items-center justify-between`}>
              ...
              >
                <Box className="flex flex-wrap gap-3 items-center mb-5" sx={darkModeColors}>
                  {" "}
                  {/* <TextField
                    className="w-[200px]"
                    label="Search"
                  ...
                  <TextField
                    ...
                    sx={{
                      ".css-2ehmn7-MuiInputBase-root-MuiOutlinedInput-root": {
                        paddingLeft: isLangRTL(i18n.language) ? "10px !important" : "0px !important",
                        paddingRight: isLangRTL(i18n.language) ? "0px !important" : "10px !important",
                      },
                      "& .MuiInputBase-root": {
                        backgroundColor: themeBgImg && (currentMode === "dark" ? blurDarkColor : blurLightColor)
                      }
                    }}
                    InputProps={{
                      endAdornment: (
                  ...
                  <Box sx={{ minWidth: "120px" }}>
                    <Select
                      id="property"
                      value={filters?.property ? property_options(t).find(option => option.value === filters?.property) : null}
                      onChange={(selectedOption) => setFilters({ ...filters, property: selectedOption?.value || null })}
                      ...
                      menuPortalTarget={document.body}
                      styles={{
                        ...selectBgStyles(currentMode, primaryColor, blurDarkColor, blurLightColor),
                  ...
                  <Box sx={{ minWidth: "120px" }}>
                    <Select
                      ...
                      onChange={(selectedOption) => setFilters({ ...filters, category: selectedOption?.value || null })}
                  ...
                  <Box sx={{ minWidth: "120px" }}>
                    <Select
                      id="bedrooms"
                      value={filters?.bedrooms ? enquiry_options(t).find(option => option.value === filters?.bedrooms) : null}
                      onChange={(selectedOption) => setFilters({ ...filters, bedrooms: selectedOption?.value || null })}
                  ...
                  <Box sx={{ minWidth: "120px" }}>
                    <Select
                      id="bathrooms"
                      value={filters?.bathrooms ? bathroom_options(t).find(option => option.value === filters?.bathrooms) : null}
                      onChange={(selectedOption) => setFilters({ ...filters, bathrooms: selectedOption?.value || null })}
                  ...
                  <Box sx={{ minWidth: "120px" }}>
                    <Select
                      id="sortby"
                      value={filters?.sort ? sortOptions.find((option) => option.value === filters?.sort) : null}
                      onChange={(selectedOption) => setFilters({ ...filters, sort: selectedOption?.value || null })}
                      options={sortOptions}
